...
A comprehensive guide to using the Cloud Healthcare API MLLP adapter is available in https://cloud.google.com/healthcare/docs/how-tos/mllp-adapter-binary-auth. This README provides a basic overview of the adapter, but you are encouraged to view the official Google Cloud documentation.
